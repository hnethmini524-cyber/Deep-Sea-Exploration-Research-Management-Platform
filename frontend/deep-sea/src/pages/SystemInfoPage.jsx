    ...
    <div className="system-info-viewport font-monospace text-white">
      ...
      <div className="glass-info-card p-4 mb-4">
        <h4 className="section-title text-info mb-3 d-flex align-items-center gap-2">
          <Info size={18} /> 1. Operational System Core
        </h4>
        <p className="text-white-80 leading-relaxed mb-0">
          <strong>OceanExplore</strong> is a centralized data platform designed for the systematic management of deep-sea exploration campaigns. 
          The application standardizes how bathymetric research zones are cataloged, tracks mission parameters, maps biological sample 
          discovery, and securely maintains researcher rosters. By providing clear permission boundaries, it guarantees data integrity 
          during high-intensity mission tracking configurations.
        </p>
      </div>
      ...
      <div className="glass-info-card p-4 mb-4">
        ...
        <p className="text-white/40 small mb-4">
        ...
        <div className="row g-4 workflow-grid">
          ...
          <div className="col-md-4">
            <div className="workflow-step-node p-3 h-100 position-relative">
              ...
              <p className="step-desc text-white/10 small mb-0">
      ...
      <div className="glass-info-card p-4">
        ...
        <p className="text-white/20 small mb-4">
        ...
        <div className="row g-4">
          ...
          <div className="col-md-6">
            <div className="role-profile-box border-admin p-3 h-100">
              <div className="d-flex align-items-center justify-content-between mb-2">
                <span className="badge bg-danger text-white px-3 py-1 font-monospace">ROLE ADMIN</span>
                <span className="text-muted small">// Root Authority</span>
              </div>
              <ul className="role-capabilities-list list-unstyled d-flex flex-column gap-2 text-white/10 small m-0 pt-2">
          ...
          <div className="col-md-6">
            <div className="role-profile-box border-researcher p-3 h-100">
              <div className="d-flex align-items-center justify-content-between mb-2">
                <span className="badge bg-primary text-white px-3 py-1 font-monospace">ROLE RESEARCHER</span>
